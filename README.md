...
## 📌 About Me
- 🎓 Currently studying: [BBA IN BUSINESS ANALYTICS (IBM)]
- 💡 Interests: Data Analysis | Web Development | AI |
- 🌱 Currently learning: [Python / SQL / Power BI / etc.]
- 🎯 Goal: To become a skilled professional and work on real-world projects

---

## 🛠️ Skills & Tools
- Programming: [Python]
- Tools: [Git, GitHub, VS Code, IBM Cognos]
- Databases: [MySQL]
...
## 📫 Contact Me
- Email: [tushirajedu@gmail.com]
- LinkedIn: [https://www.linkedin.com/in/tushiraj-sah-a53a38390?utm_source=share_via&utm_content=profile&utm_medium=member_ios]
